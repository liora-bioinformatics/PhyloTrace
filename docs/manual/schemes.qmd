...
card you saw in the Scheme Browser.
...
*Gene*, *Start*, *Length*, *Product* and *Allele Count*. The allele count is the
number of distinct alleles seen for that locus **in your database**, not in the
public scheme, so it is a direct measure of how much diversity your own
collection carries at that gene. **Export CSV** in the card header writes the
whole table out.
