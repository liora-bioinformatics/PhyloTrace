...
**Data > View** is the control that switches between them (@fig-ui-amr-heatmap),
and — like the map's mode picker — it changes which of the other controls apply.
...
For the gene heatmap and gene-level prevalence bars, **Data > Elements**
(@fig-ui-amr-data) decides what reaches the plot:
