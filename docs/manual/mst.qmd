...
The MST's right-hand sidebar has six tabs.
...
| **Cap at (× median)** | Where that cap falls. A branch longer than this multiple of the median is drawn **dashed** at the capped length, with its true distance still on the label |
...
**Width**, **Opacity (%)**, **Label size** (0 turns cluster labels off) and
**Label Colors**, which tints each label to match its blob.
