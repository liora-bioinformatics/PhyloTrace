...
carrying **Add Analysis** and a list for jumping between them. Each card's header
shows the Analysis name, when it was created and last modified, and — where the
Analysis fixes an isolate set — a padlock badge reading "*n* fixed isolates".
Inside it, the saved plots sit as a row of tiles with live thumbnails, ending in
an **Add Plot** placeholder.
...
**Add Analysis** opens a two-step dialogue:
...
it; its confirmation dialogue says so explicitly.
