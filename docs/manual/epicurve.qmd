...
Cases are grouped into intervals, chosen under **Time > Interval**
(@fig-ui-epi-time): **Day**, **Week**, **Month** or **Year**. PhyloTrace
preselects the finest interval that keeps the number of bars readable — under
about 150 — and you can override it at any time. Weeks follow the ISO-8601
convention, starting on Monday.
...
@fig-epi summarises how the curve is built; @fig-ui-epi shows a finished one,
stratified with a moving-average line and a shaded intervention period.
